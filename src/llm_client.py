...
class LLMClient:
    ...
    def call_llm(self, text: str, response_model: Optional[Type[Any]] = None, max_tokens: int = 131072, max_retries: int = 1) -> dict:
        ...
        system_msg = (
            ...
            "Assess the article for two criteria:\n"
            "1. Is it TRULY useful for an advanced student who has mastered Python basics (3+ years experience)?\n"
            "   - IGNORE: basic tutorials, common library updates, general AI hype.\n"
            "   - ACCEPT: Advanced architecture, performance optimization, deep technical implementation.\n"
            "2. Is it a SIGNIFICANT AI ecosystem news or model release (e.g., Gemma 4, MTP, major model updates)?\n"
            "   - Mark 'is_ai_news' as true only for major milestones, new SOTA models, or paradigm shifts.\n"
            "\n"
